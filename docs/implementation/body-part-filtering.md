...
`src/server/leaderboard/leaderboardBodyPartScanRoutes.js` exposes asynchronous
start/status/cancel endpoints that return only public job snapshots. Rank and
